...
void main(void)
{
    ...
    while(1)
    {
        ...
        _delay((unsigned long)((1000)*(20E6/4000.0)));
    }
}
...
void Disp_Info(uint16_t vin, uint16_t vout)
{
   ...
   char tensaoEntradaNovo[10], tensaoSaidaNovo[10];
   ...
   strncpy(tensaoEntradaNovo,tensaoEntradaConvertido, 4);
   tensaoSaidaConvertido = ftoa(leituraVout, &vout);
   strncpy(tensaoSaidaNovo,tensaoSaidaConvertido, 4);
