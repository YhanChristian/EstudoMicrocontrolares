/* Curso Formação IoT ESP32 - Utilizando ESP32 Heltec módulo LoRa SDK-IDF
   ...
   Exemplo 03: Transimissor LoRa - comunicação Ponto a Ponto
   ...
   de dados do (SLAVE) e faz validação através do CRC com interrupção.
...
/**
 * LoRa devices (qtde de Slaves = no caso estou utilizando 1 dispositivo slave no END 1  e o master no END 0);
 */
