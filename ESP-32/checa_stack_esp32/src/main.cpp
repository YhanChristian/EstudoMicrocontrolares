/* Checa consumo STACK - Curso primeiros passos com FreeRTOS
...
void vTaskBlink(void *pvParameters)
{
  ...
  while (true)
  {
    ...
    uxHighWaterMark = uxTaskGetStackHighWaterMark(NULL); //Retorna o quanto tem de espaço na memória
    Serial.println("HWM Task Blink: " + String(uxHighWaterMark));
  }
}
...
void vTask2(void *pvParameters)
{
  ...
  while (true)
  {
    ...
    uxHighWaterMark = uxTaskGetStackHighWaterMark(NULL); //Retorna o quanto tem de espaço na memória
    Serial.println("HWM Task 02: " + String(uxHighWaterMark));
  }
}