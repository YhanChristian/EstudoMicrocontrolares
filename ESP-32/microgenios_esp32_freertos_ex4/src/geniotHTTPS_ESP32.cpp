/*
 * Biblioteca desenvolvida pelo Prof. Fernando Simplicio p/ uso da API do GenIOT
 * Atualizada por Yhan Christian Souza Silva
 * alterado taskENTER_CRITICAL para portENTER_CRITICAL
 * alterado taskEXIT_CRITICAL para port_EXITCRITICAL
*/
