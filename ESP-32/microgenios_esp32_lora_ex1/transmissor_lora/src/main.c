/* Curso Formação IoT ESP32 - Utilizando ESP32 Heltec módulo LoRa SDK-IDF
   ...
   Exemplo 01: Transimissor LoRa - comunicação Ponto a Ponto
   Autor: Yhan Christian Souza Silva - data: 02/02/2021
   Descrição: Este projeto tem como objetivo criar um transmissor de dados via LoRa através de uma Task que 
  envia os dados com tamanho máximo de 255bytes.
